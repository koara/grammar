  ...
  protected JJTKoaraState jjtree = new JJTKoaraState();
    ...
    private int currentQuoteLevel = 0;
        ...
        private boolean fencesAhead() {
          System.out.println("> fencesAhead >> false");
          return false;
    }
    ...
    private boolean listItemAhead(int listBeginColumn, boolean ordered) {
        if(getToken(1).kind == EOL) {
                for(int i=2, eol=1;;i++) {
                        Token t = getToken(i);
                        if(t.kind != SPACE && t.kind != TAB && t.kind != EOL) {
                            if(ordered) {
    ...
    private boolean multilineAhead(Integer token) {
      System.out.println("> multilineAhead >> false");
      return false;
    }
...
if (jjtc000) {
  ...
  final public void UnorderedList() throws ParseException {/*@bgen(jjtree) List */
                              ...
                              boolean jjtc000 = true;
                              jjtree.openNodeScope(jjtn000);int listBeginColumn;
    try {
      listBeginColumn = UnorderedListItem();
      label_13:
      while (true) {
        if (listItemAhead(listBeginColumn, false)) {
          ;
        } else {
          break label_13;
        }
...
if (jjtc000) {
  ...
  final public int UnorderedListItem() throws ParseException {/*@bgen(jjtree) ListItem */
...
if (jjtc000) {
  ...
  final public void OrderedList() throws ParseException {/*@bgen(jjtree) List */
                            ...
                            jjtree.openNodeScope(jjtn000);int listBeginColumn;
    try {
      listBeginColumn = OrderedListItem();
      label_17:
      while (true) {
        if (listItemAhead(listBeginColumn, true)) {
          ;
        } else {
          break label_17;
        }
...
if (jjtc000) {
  ...
  final public int OrderedListItem() throws ParseException {/*@bgen(jjtree) ListItem */
                                   ASTListItem jjtn000 = new ASTListItem(JJTLISTITEM);
                                   boolean jjtc000 = true;
                                   jjtree.openNodeScope(jjtn000);Token t;
    try {
...
jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
jjtn000.setNumber(Integer.valueOf(Integer.valueOf(t.image))); {if ("" != null) return t.beginColumn;}
    } catch (Throwable jjte000) {
if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
...
if (jjtc000) {
  ...
  private boolean jj_3R_264()
 {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_scan_token(12)) { jj_scanpos = xsp; break; }
    }
    while (true) {
      xsp = jj_scanpos;
  ...
  private boolean jj_3R_54()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x200,0x200,0x200,0x1040,0x400,0x20400a,0x200,0x1000,0x200,0x1000,0x200,0x1000,0x200,0x8,0x27fdfe,0x180000,0x27fdfe,0x1000,0x8,0x1000,0x180000,0x27fdfe,0x27fdfe,0x1000,0x20400a,0x20400a,0x20400a,0x180000,0x5bdf4,0x180000,0x23fdfe,0x204008,0x204008,0x204008,0x204008,0x400a,0x400a,0x400a,0x400a,0x1000,0x180000,0x27fdf6,0x180000,0x7bdf4,0x20400a,0x180000,0x180000,0x180000,0x180000,};
   }
